...
public class Project_Percabangan {
    ...
    public static void main(String[] args){ 
       ...
       System.out.println("Idemtias :" + identitas);
        ...
        System.out.println("nIF..ELSE..");
           ...
           if(a < 2) {
              ...
              System.out.println("nilai a sama dengan 6");  
               ...
               System.out.println("nilai a lebih dari 60");
           }
           System.out.println("\nNested IF");
           if (a < 7){
               ...
               if(a < 4)
                 System.out.println("niai a kurang 4");  
               ...
               switch(a) {
                   ...
                   case 6: System.out.println("nilai a bukan antara 1-5");
                      }
               int nilai;
               System.out.print("\nNilai Anda ?");
               nilai = scanner.nextInt();
               
               String grade = (nilai < 75) ? "belum kompoten" : "kompoten";
